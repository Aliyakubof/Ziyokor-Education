...
async function testUpdate() {
    try {
        console.log('--- Student Update Test ---');
        ...
        const updateRes = await pool.query(
            ...
            [newName, student.phone || '998901234567', 'Test Parent', '998901234568', student.id]
        );
        ...
        if (updateRes.rows.length > 0) {
            ...
            await pool.query('UPDATE students SET name = $1 WHERE id = $2', [student.name, student.id]);
