...
import { Users, PlayCircle, Plus, ArrowLeft, LogOut, X, ChevronDown, Trash2, Send, Swords } from 'lucide-react';
...
const TeacherDashboard = () => {
    ...
    const handleDuelStatusToggle = async (quiz: UnitQuiz) => {
        try {
            ...
            console.error("Error toggling duel status:", err);
        }
    };
    ...
    return (
        <div className="min-h-screen p-8 bg-transparent font-sans text-slate-900">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-12 bg-white rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50 p-8">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-2xl font-black text-slate-800 tracking-tight">Duel Savollari</h2>
                                <p className="text-slate-500 font-medium">Barcha o'quvchilar uchun umumiy duel savollari</p>
                            </div>
                        </div>
                        <button
                                ...
                                <div key={quiz.id} className="group bg-white border border-slate-100 rounded-3xl p-6 hover:shadow-2xl hover:shadow-rose-500/10 hover:border-rose-200 transition-all flex flex-col justify-between">
                                    ...
                                    <div className="flex justify-between items-start mb-4">
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <button
                                                onClick={() => handleDuelStatusToggle(quiz)}
